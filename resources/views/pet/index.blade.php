    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <h4 class="mt-2">Data Pet</h4>
<a href="{{ route('pet.create') }}" type="button" class="btn btn-success rounded-3">Tambah Data</a>
    ...
    <tbody>
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    <a href="{{ route('pet.edit', $data->id) }}" type="button" class="btn btn-warning rounded-3">Ubah</a>
                    ...
                    <div class="modal fade" id="hapusModal{{ $data->id }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('pet.delete', $data->id) }}">
                                    @csrf
